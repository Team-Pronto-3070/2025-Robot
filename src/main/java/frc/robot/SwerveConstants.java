...
public class SwerveConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
            .withKP(50).withKI(0).withKD(0.5) // P 100, D 0.5
            .withKS(0.0).withKV(0.0).withKA(0) // ks 0.1, kv 1.4
            .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
            .withKP(0.1).withKI(0).withKD(0)
            .withKS(0).withKV(0.124); // kv 0.124
...
//     private static final SteerFeedbackType kSteerFeedbackType = SteerFeedbackType.FusedCANCoder;
    private static final SteerFeedbackType kSteerFeedbackType = SteerFeedbackType.RemoteSensor0; // manually override to avoid boot warning
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.340087890625);
