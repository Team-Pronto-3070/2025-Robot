...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    // Forward Camera
    // PhotonCamera cam = new PhotonCamera("Arducam_OV9281_USB_Camera");
    PhotonCamera cam = new PhotonCamera("Arducam_1");
    ...
    var pose = photonPoseEstimator.update(cam.getAllUnreadResults().get(0));
