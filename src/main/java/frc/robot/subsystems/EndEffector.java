...
public class EndEffector extends SubsystemBase {
    ...
    // private final DigitalInput coralBeamBreak = new DigitalInput(Constants.EndEffector.beamBreakPort);
    ...
    public Command intakeCoral() {
        ...
        return this.run(() -> coralMotor.set(1)).until(() -> !coralBeamBreak.get()).andThen(new WaitCommand(1)).andThen(() -> coralMotor.set(0));
    }
