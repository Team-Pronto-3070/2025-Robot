...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public Rotation2d getYaw() {
    return Rotation2d.fromDegrees(gyro.getYaw().getValueAsDouble() - gyroOffset);
  }
  ...
  public void resetOdometry(Pose2d pose) {
    // gyro.setGyroAngle(gyro.getYaw().getValueAsDouble(), pose.getRotation().getDegrees());
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("manual yaw", gyro.getYaw().getValueAsDouble());
    SmartDashboard.putNumber("manual pitch", gyro.getYaw().getValueAsDouble());
    SmartDashboard.putNumber("manual roll", gyro.getYaw().getValueAsDouble());
  }
}