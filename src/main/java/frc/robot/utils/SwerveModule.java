...
public class SwerveModule {
    ...
    public SwerveModule(int driveMotorID, int turnMotorID, double encoderOffset) {
        ...
        turningAbsoluteEncoder = new CANcoder(Constants.Swerve.Turn.encoderId);
        ...
        var turnConfig = driveMotor.getConfigurator();
        ...
        // turnCurrentLimitsConfig.SupplyTimeThreshold = Constants.Swerve.Turn.peakCurrentDuration;
        // turnCurrentLimitsConfig.SupplyCurrentThreshold = Constants.Swerve.Turn.peakCurrentLimit;
        driveConfig.apply(turnCurrentLimitsConfig);
        ...
        driveConfig.apply(turnOpenLoopRampsConfigs);
    ...
    public void setDesiredState(SwerveModuleState2 rawDesiredState, boolean isOpenLoop) {
        ...
        if (isOpenLoop) {
            driveMotor.setControl(
                    new DutyCycleOut(optimizedDesiredState.speedMetersPerSecond / Constants.Swerve.maxSpeed));
        } else {
        ...
        turnMotor.setControl(turnPosition
                .withFeedForward(turnFeedforward.calculate(optimizedDesiredState.speedMetersPerSecond)));
    }
    ...
    public SwerveModulePosition getPosition() {
        return new SwerveModulePosition(
                ...
                new Rotation2d(turningAbsoluteEncoder.getPosition().getValueAsDouble() - chassisAngularOffset));
    }
